							...
							<table class="table table-bordered table-condensed mb-none">
								...
								<tbody>
									...
									foreach ($student as $key => $row) :
										$extra_activities[$key] = json_decode($row['get_extra_marks'], true);
										?>
										<tr>
											...
											<td style="text-align: center">
												<a href="#edit" id="editExtraScores" id="<?= $key ?>"> <i class="far fa-edit"></i> </a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#editExtraScores').click( function() {
			$('#exampleModalCenter').modal('show')
		})
		
	});
	const extra_marks = <?php echo json_encode($extra_activities) ?>;
</script>