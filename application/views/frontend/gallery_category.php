<div class="row">
<?php if (get_permission('frontend_gallery_category', 'is_add')): ?>
	<div class="col-md-5">
		<section class="panel">
...
<?php if (get_permission('frontend_gallery_category', 'is_view')): ?>
	<div class="col-md-<?php if (get_permission('frontend_gallery_category', 'is_add')){ echo "7"; }else{ echo "12"; } ?>">
		<section class="panel">
			<header class="panel-heading">
...
<?php endif; ?>
								...
								<td class="min-w-xs">
								<?php if (get_permission('frontend_gallery_category', 'is_edit')): ?>
									<!-- update link -->
									<a class="btn btn-default btn-circle icon" href="javascript:void(0);" data-id="<?php echo $row['id']; ?>" data-name="<?php echo $row['name']; ?>" data-branch="<?php echo $row['branch_id']; ?>" onclick="getCategoryModal(this)">
										<i class="fas fa-pen-nib"></i>
									</a>
								<?php endif; if (get_permission('frontend_gallery_category', 'is_delete')): ?>
									<!-- delete link -->
									<?php echo btn_delete('frontend/gallery/category_delete/' . $row['id']); ?>
								<?php endif; ?>
								</td>
							</tr>
						<?php
		...
		<?php echo form_open('frontend/gallery/category_edit', array('class' => 'frm-submit')); ?>
			<div class="panel-body">
				...
				<div class="form-group mb-md">
					...
					<input type="text" class="form-control" value="" name="category_name" id="ename" />
					<span class="error"></span>
				</div>
			</div>
